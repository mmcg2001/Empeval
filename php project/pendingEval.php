...
$tSql->setFetchMode(PDO::FETCH_ASSOC);
	...
	echo "<thead><tr><th class='col-xs-2'>Employee Name</th><th class = 'col-xs-2'>2 weeks</th><th class = 'col-xs-2'>Training Title</th></tr></thead><tbody>";
...
$thSql->setFetchMode(PDO::FETCH_ASSOC);
	...
	echo "<thead><tr><th class='col-xs-2'>Employee Name</th><th class = 'col-xs-2'>30 Days</th><th class = 'col-xs-2'>Training Title</th></tr></thead><tbody>";
...
$nSql->setFetchMode(PDO::FETCH_ASSOC);
	...
	echo "<thead><tr><th class='col-xs-2'>Employee Name</th><th class = 'col-xs-2'>90 Days</th><th class = 'col-xs-2'>Training Title</th></tr></thead><tbody>";
